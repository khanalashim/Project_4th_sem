                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($row['status'] == 'f') {
                                            ...
                                            echo "<td><input type='date' name='' value='" . $row['fromdate'] . "'></td>";
                                            echo "<td><input type='date' name='' value='" . $row['todate'] . "'></td>";

                                            echo "<td id='action'><a href='booking_edit_process.php?edit_id=$id'><button>Submit</button></a>";
                                            echo "</tr>";
                                        }
